...
import sidrafashion.apparel.sidrastylepulse.di.dataModule
import sidrafashion.apparel.sidrastylepulse.di.dispatcherModule
import sidrafashion.apparel.sidrastylepulse.di.viewModule
...
class DDHKOApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@DDHKOApplication)
            modules(appModules)
        }
